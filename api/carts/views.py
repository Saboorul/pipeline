...
def add_to_cart(request, product_id):
    ...
    try:
        ...
        cart_item = CartItems.objects.create(product=product, cart=cart, quantity=1, total=product.price)
        cart_item.save()
...
def cart_products(request):
    ...
    try:
        if _cart_id(request):
            ...
            context = {"cart_ps": cart_p, "cart_total": cart_total, "cart_tax": cart_tax, "grand_total": grand_total}
        else:
            context = {}
    except:
        context = {}
